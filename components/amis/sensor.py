    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_REACTIVE_ENERGY_A_POSITIVE): sensor.sensor_schema(
                UNIT_VOLT_AMPS_REACTIVE_HOURS, ICON_EMPTY, 0, DEVICE_CLASS_ENERGY, STATE_CLASS_MEASUREMENT
            ),
            ...
            cv.Optional(CONF_REACTIVE_INSTANTANEOUS_POWER_A_POSITIVE): sensor.sensor_schema(
                UNIT_VOLT_AMPS_REACTIVE, ICON_EMPTY, 0, DEVICE_CLASS_POWER, STATE_CLASS_MEASUREMENT
            ),
...
#                UNIT_SECOND, ICON_EMPTY, 0, DEVICE_CLASS_TIMESTAMP
#            ),
        }
    )
